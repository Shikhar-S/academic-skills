...
本技能提供一套系統化的學術論文審稿流程，適用於頂級會議（如 NeurIPS、ICML、ICLR、ACL、CVPR 等）與期刊的同儕審查。整個流程分為四個步驟，四步皆以英文進行並產出符合會議格式的正式審稿。
...
| 步驟 | 名稱 | 語言 | 目的 |
|------|------|------|------|
| Step 1 | 批判性審查 | 英文 | 深入閱讀，找出優缺點 |
| Step 2 | 分數預測 | 英文 | 各維度評分與整體分數預測 |
| Step 3 | 要點精煉 | 英文 | 將發現整理為結構化要點 |
